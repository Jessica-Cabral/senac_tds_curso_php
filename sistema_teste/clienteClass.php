...
class ClienteClass
{
    ...
    /**
     * Get the value of observacao_cliente
     */
    ...
    /**
     * Set the value of observacao_cliente
     */
    public function setObservacaoCliente($observacao_cliente): self
    {
    ...
    /**
     * Get the value of dataNascimento_cliente
     */
    ...
    /**
     * Set the value of dataNascimento_cliente
     */
    public function setDataNascimentoCliente($dataNascimento_cliente): self
    {
    ...
    //Métodos
    public function inserir_cliente($nome, $dataNascimento, $email, $cpf, $observacao, $estado){
        //setar os valores
        $this->setNomeCliente($nome);
        $this->setDataNascimentoCliente($dataNascimento);
        $this->setEmailCliente($email);
        $this->setCpfCliente($cpf);
        $this->setObservacaoCliente($observacao);
        $this->setEstadoCliente($estado);

        //conexão com o banco de dados - insert dos dados
        $resultado = true;
    ...
    public function alterar_cliente($nome, $email, $observacao){
        //setar valores
        $this->setNomeCliente($nome);
        $this->setEmailCliente($email);
        $this->setCpfCliente($observacao);

        //conectar com o banco de dados e altera os dados
        $resultado = true;
        //testar e validar
        if($resultado == true){
                //mensagem
            $_SESSION['mensagem'] = "Cliente alterado com sucesso!";
            echo $_SESSION['mostrar_mensagem'] = true;
            header('Location: consultar.php');
        } else {
